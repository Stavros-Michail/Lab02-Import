...
author: "Team Name: Stavros, Fraser, Shayan, Leo"
date: "`r Sys.Date()`"
...
data1 <- read_csv2("data/per-capita-ocean-plastic-waste.txt")
...
total_mismanaged_plastic <- 
  plastic_data_all %>% 
  mutate(mismanaged_plastic_ocean.x * population)
